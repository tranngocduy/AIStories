...
type TTypeFilterState = 'author' | '';

type TTypeFilterRefs = { setTypeFilter: (type: TTypeFilterState) => void };

type TTypeFilterProps = { onGenerateQuery: Function, onBack: Function, onClose: Function };
