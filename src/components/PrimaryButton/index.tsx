...
type TPrimaryButtonProps = { label?: string, style?: ViewStyle, labelStyle?: TextStyle, color?: string, disabled?: boolean, onPress: Function };

export type TPrimaryButtonRefs = { startLoad: () => void, stopLoad: () => void, enabled: (status: boolean) => void };

export const PrimaryButton = forwardRef<TPrimaryButtonRefs, TPrimaryButtonProps>(({ label, style, labelStyle, color, onPress, ...props }, ref) => {
