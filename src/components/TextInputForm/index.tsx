...
import TextMsgError from '@/components/TextMsgError';
import { TouchableView } from '@/components/TouchableView';

import { styles } from './styles';

type TTextInputForm = { inputIcon?: React.JSX.Element, error?: string } & TextInputProps;

export const TextInputForm: React.FC<TTextInputForm> = ({ inputIcon, error, ...props }) => {
